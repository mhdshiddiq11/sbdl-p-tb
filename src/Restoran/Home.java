...
public class Home extends javax.swing.JFrame {
    ...
    public void LoadData() {
        ...
        try {
            ...
            String sql = "SELECT * FROM v_pesanan";
            ResultSet r = st.executeQuery(sql);
            
            while(r.next()) {
                Object[] obj = new Object[7];
                obj[1] = r.getString("kodepesanan");
                obj[2] = r.getString("namapelanggan");
                obj[3] = r.getString("namamenu");
                obj[4] = r.getString("jumlah");
                obj[5] = r.getString("total");
                obj[6] = r.getString("dibuat");
    ...
    public void countPsn(){
        try{
            java.sql.Connection conn=(Connection)config.configDB();
            String q = "SELECT COUNT(*) FROM v_pesanan";
            java.sql.PreparedStatement ps = conn.prepareStatement(q);
            java.sql.ResultSet res = ps.executeQuery();
            res.next();
            labelCount.setText("Jumlah Pesanan: "+ res.getString(1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    //try {
        ...
        //stmt = config.configDB().createStatement();


        //p_get_count should be replaced by your procedure name
        //String s1 = "CALL status_tx(?);";
        //cstmt = (CallableStatement) config.configDB().prepareCall(s1);
        //cstmt.registerOutParameter(1, Types.TINYINT);
        //cstmt.execute();
        //String s2 = cstmt.getString(1);
        //labelCount.setText("Jumlah Pesanan "+s2);
        //cstmt.close();
        //stmt.close();
...
//}
    ...
    private void initComponents() {
        ...
        tablePesanan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Kode Pesanan", "Nama Pelanggan", "Menu", "Jumlah", "Total", "Dibuat"
            }
        ) {
        ...
        if (tablePesanan.getColumnModel().getColumnCount() > 0) {
            ...
            tablePesanan.getColumnModel().getColumn(0).setPreferredWidth(1);
            tablePesanan.getColumnModel().getColumn(4).setPreferredWidth(50);
            tablePesanan.getColumnModel().getColumn(4).setMaxWidth(70);
            tablePesanan.getColumnModel().getColumn(5).setPreferredWidth(50);
            tablePesanan.getColumnModel().getColumn(5).setMaxWidth(70);
            tablePesanan.getColumnModel().getColumn(6).setResizable(false);
            tablePesanan.getColumnModel().getColumn(6).setPreferredWidth(30);
        }

        labelCount.setForeground(java.awt.Color.white);
